...
public class DisplayCourses extends Activity {
	...
	private void displayCourses() {
		...
		SQLiteHelper.NAME, SQLiteHelper.LOCATION };

		int[] to = new int[] { R.id.tvCourse, R.id.tvLocation };

		cursorAdapter = new SimpleCursorAdapter(this,
				R.layout.display_course_list_entry, dataSource.getAllCourses(),
				columns, to, 0);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> listView, View view,
				...
				//
				Intent intent = new Intent(DisplayCourses.this,
						CourseView.class);
